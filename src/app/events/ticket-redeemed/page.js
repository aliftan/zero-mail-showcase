...
<mjml>
  ...
  <mj-body background-color="#f4f4f4">
    ...
    <mj-section background-color="#ffffff" padding-top="40px" padding-bottom="40px">
      <mj-column>
        <mj-text font-size="28px" color="#1a2b49" align="center" font-weight="bold">Ticket Redeemed</mj-text>
        <mj-text font-size="16px" color="#555555">
          Dear {{customerName}},
          <br><br>
          This email confirms that your ticket for {{eventName}} has been successfully redeemed for entry.
        </mj-text>
      </mj-column>
    </mj-section>
        ...
        <mj-table css-class="ticket">
          ...
          <tr>
            <td class="ticket-body" style="width: 70%; position: relative;">
              <div class="redeemed-stamp">REDEEMED</div>
              ...
              <strong>Redeemed At:</strong> {{redemptionTime}}
            </td>
          ...
          <tr>
            <td class="ticket-footer" colspan="2">
              This ticket has been redeemed and is no longer valid for entry.
            </td>
          </tr>
        </mj-table>
      </mj-column>
    ...
    <mj-section background-color="#ffffff" padding-top="20px">
      <mj-column>
        ...
        <mj-text>
          • This ticket has been marked as used and cannot be redeemed again.
          <br>
          • Keep this email for your records.
          <br>
          • If you have any issues during the event, please visit the information desk.
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#ffffff" padding-top="20px">
      <mj-column>
        <mj-text>
          We hope you enjoy the event! If you have any questions or concerns, please don't hesitate to contact our support team.
        </mj-text>
        <mj-button background-color="#e74c3c" color="#ffffff" href="{{eventInfoUrl}}">Event Information</mj-button>
      </mj-column>
    </mj-section>
...
export default function TicketRedeemedPage() {
    return (
        <EmailTemplatePage
            moduleName="Event Tickets"
            templateName="Ticket Redeemed"
            mjmlContent={ticketRedeemedMjml}
        />
    );
}