...
const appointmentConfirmedMjml = `
<mjml>
  <mj-head>
    <mj-attributes>
  ...
  <mj-body background-color="#f4f4f4">
    ...
    <mj-section background-color="#ffffff" padding="20px" border-radius="8px">
      <mj-column>
        <mj-text font-size="24px" color="#333333" align="center">Your Appointment is Confirmed</mj-text>
        ...
        <mj-text font-size="16px" color="#555555">
          <br>
          Please arrive a few minutes early for your appointment. If you need to reschedule or cancel, please do so at least 24 hours in advance.
          <br><br>
...
export default function AppointmentConfirmedPage() {
    return (
        <EmailTemplatePage
            ...
            mjmlContent={appointmentConfirmedMjml}
        />
    );
}