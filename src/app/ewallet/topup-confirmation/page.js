...
<mjml>
  ...
  <mj-body background-color="#f4f4f4">
    ...
    <mj-section background-color="#ffffff" padding="20px" border-radius="8px">
      <mj-column>
        <mj-text font-size="24px" color="#333333" align="center">Top-up Confirmation</mj-text>
        <mj-text font-size="16px" color="#555555">
          Dear {{name}},
          <br><br>
          Your e-wallet has been successfully topped up. Here are the details of your transaction:
        </mj-text>
        <mj-table>
        ...
        <mj-text font-size="16px" color="#555555">
          <br>
          Thank you for using our e-wallet service. If you have any questions, please don't hesitate to contact our support team.
        </mj-text>
...
export default function TopupConfirmationPage() {
    return (
        <EmailTemplatePage
            moduleName="E-Wallet"
            templateName="Top-up Confirmation"
            mjmlContent={topupConfirmationMjml}
        />
    );
}