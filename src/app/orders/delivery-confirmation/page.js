...
const deliveryConfirmationMjml = `
<mjml>
  <mj-head>
    <mj-attributes>
  ...
  <mj-body background-color="#f4f4f4">
    ...
    <mj-section background-color="#ffffff" padding-top="40px" padding-bottom="40px">
      <mj-column>
        <mj-text font-size="28px" color="#1a2b49" align="center" font-weight="bold">Your Order Has Been Delivered!</mj-text>
        <mj-text font-size="16px" color="#555555" padding-top="30px">
          Dear {{customerName}},
          <br><br>
          Great news! Your order #{{orderNumber}} has been successfully delivered. We hope you're excited to unbox your items!
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#ffffff" padding-top="20px">
      <mj-column>
        <mj-text font-weight="bold" font-size="20px" color="#1a2b49">Delivery Details</mj-text>
        <mj-text>
...
export default function DeliveryConfirmationPage() {
  return (
    <EmailTemplatePage
      ...
      mjmlContent={deliveryConfirmationMjml}
    />
  );
}