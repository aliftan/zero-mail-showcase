    ...
    return (
        <header className="text-center mb-12">
            ...
            <a
                ...
                className="inline-flex items-center px-4 py-2 bg-gray-800 text-white rounded-full hover:bg-gray-700 text-sm font-medium transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-lg"
            >
